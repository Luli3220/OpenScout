...
- [简介](#简介)
- [核心特性](#核心特性)
  - [1. 智能语义搜索](#1-智能语义搜索-smart-search)
  - [2. 多智能体分析流水线](#2-基于-maxkb-的多智能体分析流水线)
  - [3. 多维度能力雷达](#3-多维度能力雷达-6-dimension-radar)
  - [4. 仓库智能分析](#4-仓库智能分析)
- [技术架构](#技术架构)
- [安装部署](#安装部署)
...
![智能语义搜索演示](image/screenshot-smart-search.png)

### 2. 基于 MaxKB 的多智能体分析流水线
#### Agents 职责概览
...
- **分析层 (AI Agents)**：
  ...
  - **LLM**：
    - **Search Embedding**：使用 `qwen3-text-embedding-v4` 模型生成用户画像向量。
...
```json
{
  // GitHub 个人访问令牌 (Classic 或 Fine-grained)
...
## MaxKB 智能体配置[MaxKB配置文档](Intro2MaxKB.md)
...
## 成员分工
- 队长：[@Luli3220]杨子炫(https://github.com/Luli3220) ：智能语义搜索、MaxKB编排与配置、数据挖掘、后端搭建、报告撰写+PPT制作
- 队员：[@pck-altra]潘淳恺(https://github.com/pck-altra) ：前端开发、前后端通信、数据挖掘、视频录制、PPT制作
